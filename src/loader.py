...
def load_documents(data_dir: str = "data/") -> List:
    ...
    loader = WebBaseLoader(
        web_path="https://www.sptlabtech.com/product-help-center/lab2lab-lab-managers-manual-before-use-5.2-software-installation",
        bs_kwargs=dict(
            parse_only=bs4.SoupStrainer("div", {"class": "article-content"})
        )
    )
